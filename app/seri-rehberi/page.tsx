...
import { Users, Layers, Feather, ChevronRight } from "lucide-react";
...
export default async function SeriesGuidePage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
      ...
      {/* ── 📊 Külliyat Hızlı İstatistik Paneli ── */}
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3.5 mb-12">
      ...
      {/* ── ✍️ BÖLÜM 2: KÜLLİYAT ÇEVİRMENLERİ ATLASI (VİKİPEDİ DOĞRULANMIŞ) ── */}
      <section className="mb-14">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-3 border-b border-[var(--border-main)]">
          ...
          <span className="text-xs font-bold text-[var(--text-muted)]">
            Vikipedi arşiv kayıtlarıyla doğrulanmıştır
          </span>
        </div>
