...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--border-main)] bg-[var(--surface-card)]/40 py-10 mt-20 text-xs text-[var(--text-muted)]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-[var(--text-primary)]">İthaki Bilimkurgu Klasikleri (BKK)</span>
