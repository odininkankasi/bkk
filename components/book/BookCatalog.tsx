...
export default function BookCatalog({ initialBooks }: Props) {
  ...
  return (
    <div>
      ...
      <div className="bg-[var(--surface-card)] border border-[var(--border-main)] rounded-2xl p-5 sm:p-6 mb-8 shadow-xs">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          <div>
            ...
            <div className="font-serif font-bold text-xl sm:text-2xl text-[var(--text-primary)] mt-0.5">
              {readCount} / {total} Kitap Okundu <span className="text-[var(--accent)] text-lg sm:text-xl font-sans font-semibold">(%{pct})</span>
            </div>
          </div>
        ...
        {/* İlerleme Çubuğu */}
        <div className="w-full bg-[var(--bar-bg)] h-2.5 rounded-full overflow-hidden mb-5">
          <div
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
          <div className="bg-[var(--surface-sub)] border border-[var(--border-main)] rounded-xl p-3">
            <div className="text-lg sm:text-xl font-bold text-[var(--text-primary)]">{total}</div>
            <div className="text-[11px] font-bold text-[var(--text-muted)] uppercase">Toplam Eser</div>
          </div>
          <div className="bg-[var(--surface-sub)] border border-[var(--border-main)] rounded-xl p-3">
            <div className="text-lg sm:text-xl font-bold text-[var(--read-tag-text)]">{readCount}</div>
            <div className="text-[11px] font-bold text-[var(--text-muted)] uppercase">Okunan</div>
          </div>
          <div className="bg-[var(--surface-sub)] border border-[var(--border-main)] rounded-xl p-3">
            <div className="text-lg sm:text-xl font-bold text-[var(--gold)]">{unreadCount}</div>
            <div className="text-[11px] font-bold text-[var(--text-muted)] uppercase">Okunacak</div>
          </div>
          <div className="bg-[var(--surface-sub)] border border-[var(--border-main)] rounded-xl p-3">
            <div className="text-lg sm:text-xl font-bold text-[var(--owned-tag-text)]">{ownedCount}</div>
      ...
      <div className="sticky top-18 z-30 bg-[var(--bg-page)]/95 backdrop-blur-md border border-[var(--border-main)] rounded-2xl p-3.5 sm:p-4 mb-6 shadow-xs">
        {/* Arama Çubuğu */}
        <div className="relative mb-3">
          ...
          <input
            ...
            className="w-full bg-[var(--surface-input)] border border-[var(--border-main)] rounded-xl py-2.5 pl-10 pr-4 text-sm font-medium text-[var(--text-primary)] placeholder:text-[var(--text-muted)] focus:outline-none focus:border-[var(--accent)] transition-colors"
          />
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 ml-auto">
            <select
              ...
              className="bg-[var(--surface-card)] text-[var(--text-primary)] text-xs font-semibold px-2.5 py-1.5 rounded-lg border border-[var(--border-main)] focus:outline-none focus:border-[var(--accent)] cursor-pointer"
            >
            ...
            <div className="flex items-center border border-[var(--border-main)] rounded-lg p-0.5 bg-[var(--surface-card)]">
              <button
                ...
                className={`p-1.5 rounded-md transition-colors cursor-pointer ${
                  viewMode === "list"
                    ? "bg-[var(--surface-sub)] text-[var(--text-primary)] font-bold"
