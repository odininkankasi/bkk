...
export default async function StatisticsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
      ...
      <div className="bg-white dark:bg-[#131720] border border-[#e7e2d7] dark:border-[#232a36] rounded-2xl p-6 sm:p-8 mb-8 shadow-xs">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
          ...
          <div className="text-right">
            ...
            <div className="font-serif font-bold text-2xl text-amber-700 dark:text-amber-400 flex items-center gap-1">
              <span>★ {avgRating}</span>
        ...
        {/* Bar */}
        <div className="w-full bg-[#f3efe6] dark:bg-[#1a202c] h-3 rounded-full overflow-hidden mb-6">
          <div
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
          <div className="bg-[#fbf9f5] dark:bg-[#0c0f14] border border-[#e7e2d7] dark:border-[#232a36] rounded-xl p-3.5">
          ...
          <div className="bg-[#fbf9f5] dark:bg-[#0c0f14] border border-[#e7e2d7] dark:border-[#232a36] rounded-xl p-3.5">
            ...
            <div className="text-xl font-bold text-emerald-700 dark:text-emerald-400">{readCount}</div>
          ...
          <div className="bg-[#fbf9f5] dark:bg-[#0c0f14] border border-[#e7e2d7] dark:border-[#232a36] rounded-xl p-3.5">
            ...
            <div className="text-xl font-bold text-amber-700 dark:text-amber-400">{unreadCount}</div>
            <div className="text-[11px] font-bold text-stone-500 dark:text-stone-400 uppercase">Okunacak</div>
          </div>

          <div className="bg-[#fbf9f5] dark:bg-[#0c0f14] border border-[#e7e2d7] dark:border-[#232a36] rounded-xl p-3.5">
            <Library className="w-5 h-5 text-blue-600 dark:text-blue-400 mx-auto mb-1" />
            <div className="text-xl font-bold text-blue-700 dark:text-blue-400">{ownedCount}</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Sol: Yazar Dağılımı */}
        <div className="bg-white dark:bg-[#131720] border border-[#e7e2d7] dark:border-[#232a36] rounded-2xl p-6 shadow-xs">
          ...
          <div className="space-y-4">
            <div>
              <div className="flex justify-between text-xs font-bold mb-1">
                <span className="text-amber-600 dark:text-amber-400 font-serif">★★★★★ (5 Yıldız)</span>
                <span className="text-stone-600 dark:text-stone-400">{rating5} Eser</span>
              </div>
              <div className="w-full bg-[#f3efe6] dark:bg-[#1a202c] h-2 rounded-full overflow-hidden">
                <div
            ...
            <div>
              <div className="flex justify-between text-xs font-bold mb-1">
                <span className="text-amber-600 dark:text-amber-400 font-serif">★★★★☆ (4 Yıldız)</span>
            ...
            <div>
              <div className="flex justify-between text-xs font-bold mb-1">
                <span className="text-amber-600 dark:text-amber-400 font-serif">★★★☆☆ (3 Yıldız)</span>
